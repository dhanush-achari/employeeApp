...
<div class="page-wrapper projects-list">
	...
	<div class="container-fluid px-4">
		<div class="row m-b-10 pt-2">
			<div class="col-12 pb-2">
				<?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>

				<?php } else { ?>
					<button type="button" class="btn-rounded btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Add Project </a></button>
				<?php } ?>
			</div>
		</div>
		<div class="row">
									...
									<?php foreach ($projects as $value) : ?>
										<tr>
											...
											<td class="jsgrid-align-center d-flex">
												<a href="view?P=<?php echo base64_encode($value->id); ?>" title="Edit" class="btn-circle btn-info d-flex justify-content-center mr-3 align-items-center waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
												<a href="pDelet?D=<?php echo base64_encode($value->id); ?>" title="Delete" onclick="alert('Are You Sure To Delete This Project?')" class="btn-circle btn-danger d-flex justify-content-center mr-3 align-items-center waves-effect waves-light projectdelet"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
