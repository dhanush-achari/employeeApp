...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-primary"><i class="fa fa-users"></i> <?php echo $basic->first_name . ' ' . $basic->last_name; ?></h3>
		</div>
									...
									<?php } else { ?>
										<div class="form-group">
											<div class="col-sm-12">
												...
												<button type="submit" class="btn-rounded btn-info">Add File</button>
											</div>
										</div>
									<?php } ?>
								</form>
							...
							<div class="card-body">
								<form class="row" action="Reset_Password_Hr" method="post" enctype="multipart/form-data">
									...
									<?php } else { ?>
										<div class="form-actions col-md-12">
											<input type="hidden" name="emid" value="<?php echo $basic->em_id; ?>">
											<button type="submit" class="btn-rounded btn-info pull-right"> <i class="fa fa-check"></i> Save</button>
										</div>
									<?php } ?>
								</form>
							</div>
										...
										<?php } else { ?>
											<div class="form-group">
												<div class="col-sm-12">
													...
													<?php } ?>
													<button <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> disabled <?php } ?> type="submit" style="float: right" class="btn-rounded btn-info">Add Salary</button>
												</div>
											<?php } ?>
											</div>
									</form>
