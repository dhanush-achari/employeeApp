      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"><i class="fa fa-university" aria-hidden="true"></i> Employee</h3>
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row m-b-10 pt-2"> 
                    <div class="col-12 pb-2">
                        <button type="button" class="btn-rounded btn-info"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/Employees" class="text-white"><i class="" aria-hidden="true"></i>  Employee List</a></button>
                    </div>
                </div>
               <div class="row">
                    <div class="col-12">
