...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-primary"><i class="fa fa-clipboard"></i> Notice Board</h3>
		</div>
	...
	<div class="container-fluid px-4">
		<div class="row m-b-10 py-2">
			<div class="col-12">
				<button type="button" class="btn-rounded btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#noticemodel" data-whatever="@getbootstrap" class="text-white "><i class="" aria-hidden="true"></i> Add Notice </a></button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
