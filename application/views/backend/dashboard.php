...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text"><i class="fa fa-braille"></i>&nbsp Dashboard</h3>
		</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex flex-row">
								<div class="round"><i class="ti-user"></i></div>
								<div class="m-l-10 align-self-center">
									<h3 class="m-b-0">
										...
										?> Employees</h3>
									<a href="<?php echo base_url(); ?>employee/Employees" class=" font-size-12 text-muted m-b-0">View Details</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							<div class="d-flex flex-row">
								...
								<div class="m-l-10 align-self-center">
									...
									<a href="<?php echo base_url(); ?>Projects/All_Projects" class="font-size-12 text-muted m-b-0">View Details</a>
								</div>
							</div>
						</div>
					</div>
