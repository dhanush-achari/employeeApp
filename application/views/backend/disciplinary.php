...
<div class="page-wrapper disciplinary-list">
	<?php
	$allemployees = $this->employee_model->GetAllEmployee();
	?>
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-primary"><i class="fa fa-compass" style="color:0d6efd"></i> Disciplinary</h3>
		</div>
	...
	<div class="container-fluid  p-2 px-4">
		...
		<div class="row m-b-10">
			<div class="col-12 pb-2">
				<button type="button" class="btn-rounded btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Add Disciplinary </a></button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
								...
								<tbody>
									<?php foreach ($desciplinary as $value) : ?>
										<tr>
											...
											<td><button class="btn-rounded btn-sm btn-success"><?php echo $value->action; ?></button></td>
											<td class="jsgrid-align-center d-flex">
												<a href="#" title="Edit" class="btn-circle btn-info d-flex justify-content-center mr-3 align-items-center waves-effect waves-light disiplinary" data-id="<?php echo $value->id; ?>"><i class="fa fa-pencil-square-o"></i></a>
												<a href="DeletDisiplinary?D=<?php echo $value->id; ?>" onclick="confirm('Are you sure to delete this value?')" title="Delete" class="btn-circle btn-danger d-flex justify-content-center mr-3 align-items-center waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
