                                ...
                                <tr>
                                    ...
                                    <th>Status </th>
											...
											<?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
												...
												<button type="button" class="btn btn-warning" onclick="">Check your credit score</button>
