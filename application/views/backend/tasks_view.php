...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-primary"><i class="fa fa-tasks" aria-hidden="true"></i> Tasks</h3>
		</div>
	...
	<div class="container-fluid px-4">
		...
		<div class="row m-b-10 py-2">
			<div class="col-12">
				<?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>

				<?php } else { ?>
					<button type="button" class="btn-rounded btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Add Task </a></button>
				<?php } ?>
			</div>
		</div>
		<div class="row">
									...
									<?php foreach ($tasks as $value) : ?>
										<tr>
											...
											<td class="jsgrid-align-center d-flex">
												<a href="#" title="Edit" class="btn-circle btn-info d-flex justify-content-center align-items-center waves-effect mr-2 waves-light taskmodal" data-id="<?php #echo $value->id 
																																																													?>"><i class="fa fa-pencil"></i></a>
												<a onclick="alert('Are you sure, you want to delete this?')" href="#" title="Delete" class="btn-circle btn-danger d-flex justify-content-center align-items-center waves-effect waves-light TasksDelet" data-id="<?php #echo $value->id 
		...
		$(document).ready(function() {
			$(".proid").click(function(e) {
				...
				$.ajax({
					...
					console.log(response);
					// Populate the form fields with the data returned from server
					// $('#tasksModalform').find('[name="projectid"]').val(response.provalue.pro_name).end();
