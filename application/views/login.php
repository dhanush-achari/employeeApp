...
<head>
    ...
    <script>
        async function Connect() {
            ...
            console.log(web3);
            window.localStorage.setItem("val","memememem")
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                 ...
                 <div class="form-check">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn-rounded btn-info btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Log In</button>
                        </div>
                    </div>
                </form>
            </div>
